...
steps = 0
active_water = [[500 - x_min, 0]]
loop do
    flowing = false
    next_step_water = []
    active_water.each do |water|
        next_step_water << water
        x, y = water
        next if y == y_max
    ...
    # pp active_water, next_step_water
    active_water = next_step_water
    steps += 1
...
puts 'done.', steps, count - y_min, safe
